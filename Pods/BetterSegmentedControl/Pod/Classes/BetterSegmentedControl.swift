...
open class BetterSegmentedControl: UIControl {
    // MARK: IndicatorView
    ...
    //fileprivate var customViewWidth: CGFloat? = 0
    ...
    fileprivate lazy var defaultTitles: [String] = { return ["First", "Second","Third"] }()
    ...
    fileprivate func finishInit() {
        ...
        // customView.frame =  CGRect(x: 0, y: 0, width: customViewWidth!, height: 8)
